    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          name: "canonical",
          required: false,
          description: "Use this if you are republishing content from another website"
        },
        {
          type: "image",
          label: "Image",
...
// .tina/config.ts
var apiURL = true ? "http://localhost:4001/graphql" : `https://content.tinajs.io/content/${process.env.NEXT_PUBLIC_TINA_CLIENT_ID}/github/${branch}`;
var tinaConfig = defineConfig2({
